...
for($a=0; $a < mysqli_num_rows($Consulta) ; $a++)
  ...
  echo ("<td> $fila[7] </td>");
    ...
    echo ("<td> <a href='ActualizarClientes.php?Id=".$fila[0]."&Nombre=".$fila[1]."&DomicilioFiscal=".$fila[2]."&DomicilioParticular=".$fila[3]."&RFC=".$fila[4]."&Telefono=".$fila[5]."&Correo=".$fila[6]."&Status=".$fila[7]."'> Actualizar</a></td>");

	echo ("<td>  <a href='EliminarClientes.php?Id=".$fila[0]."'>Eliminar</a>             </td>");
