...
if ( array_key_exists("ActualizarCuentaPorCobrar", $_POST) ) {



$IdCuentaPorCobrar = $_POST['id'];
$Fecha = $_POST['Fecha'];
$Monto = $_POST['Monto'];
$Status = $_POST['Status'];
$Plazo = $_POST['Plazo'];
...
$Con=Conectar();
$Query="UPDATE fincuentasporcobrar
SET Fecha='".$Fecha."',Monto='".$Monto."',Status='".$Status."',Plazo='".$Plazo."',Tasa='".$Tasa."',IdVenta='".$IdVenta."' WHERE IdCuentaPorCobrar=".$IdCuentaPorCobrar;

Ejecutar($Query,$Con);
Desconectar($Con);
header("Location: ConsultaFINCuentasPorCobrar.php");
}
...
<title>Actualizar Cuentas Por Cobrar</title>
...
<div align="center">
                    <h1 class="page-header">Actualizar Cuentas Por Cobrar</h1>
</div>
...
<form method="post" name="form2" action="">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input class="btn btn-default" type="submit" value="Actualizar" name="ActualizarCuentaPorCobrar"></td>
    </tr>
  </table>
