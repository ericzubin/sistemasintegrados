...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO finegresos (IdEgreso, Fecha, Monto, Status, IdSuministro) VALUES (%s, %s, %s, %s, %s)",
...
<div align="center">
                    <h1 class="page-header">Insertar Egresos</h1>
</div>
