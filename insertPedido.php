...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO compedidos (IdPedido, Fecha, Status, IdProveedor, IdProducto) VALUES (%s, %s, %s, %s, %s)",
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="IdPedido" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
