...
$query_R18 = "SELECT * FROM invcategoriasproductos";
...
<title>Mostrar categorias productos</title>
...
<div align="center">
                    <h1 class="page-header">Mostrar categorias productos</h1>
</div>
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" class="table table-striped table-bordered table-hover">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_R18['IdCategoria']; ?></td>
