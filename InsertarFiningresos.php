...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
      $Con=Conectar();
      $sql= "INSERT INTO finingresos VALUES(".$_POST['Idcampo'].",".$_POST['campo1'].",".$_POST['campo2'].",".$_POST['campo3'].");";
      Ejecutar($sql,$Con);
}
...
<div align="center">
                    <h1 class="page-header">Insertar Ingresos</h1>
</div>
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input class="form-control" type="date" name="campo1" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
