...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="TipoCuenta" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Intentos:</td>
      <td><input type="text" name="Intentos" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="FechaUltimoAcceso" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">IdTipo:</td>
      <td><input type="text" name="IdTipo" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
