...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO invcategoriasproductos (IdCategoria, Nombre, Status, IdProducto) VALUES (%s, %s, %s, %s)",
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="IdCategoria" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
