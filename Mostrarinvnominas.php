...
$query_R18 = "SELECT * FROM invnominas";
...
<div align="center">
                    <h1 class="page-header">Mostrar Nominas</h1>
</div>
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" class="table table-striped table-bordered table-hover">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_R18['IdNomina']; ?></td>
        <td><?php echo $row_R18['Monto']; ?></td>
        <td><?php echo $row_R18['FechaPago']; ?></td>
        <td><?php echo $row_R18['MotivoPago']; ?></td>
        <td><?php echo $row_R18['Dias']; ?></td>
