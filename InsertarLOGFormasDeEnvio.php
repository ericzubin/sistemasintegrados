...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO logformasdeenvio (IdFormaEnvio, Nombre, Status, Observacion) VALUES (%s, %s, %s, %s)",
...
<title>Insertar Forma De Envio</title>
...
?>
<div align="center">
                    <h1 class="page-header">Insertar Forma de Envio</h1>
</div>
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input  class="btn btn-default"  type="submit" value="Insert Forma De Envio"></td>
    </tr>
  </table>
