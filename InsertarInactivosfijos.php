...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
      $Con=Conectar();
      $sql= "INSERT INTO invactivosfijos VALUES(".$_POST['Idcampo'].",'".$_POST['campo1']."','".$_POST['campo2']."','".$_POST['campo3']."','".$_POST['campo4']."',".$_POST['campo5'].");";
      Ejecutar($sql,$Con);
}
...
<title>Insertar Activos Fijos</title>
...
<div align="center">
                    <h1 class="page-header">Insertar Activos Fijos</h1>
</div>
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input  class="form-control" type="text" name="campo2" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right">Tipo Activo:</td>
