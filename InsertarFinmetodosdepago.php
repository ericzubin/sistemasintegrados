...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
      $Con=Conectar();
      $sql= "INSERT INTO finmetodosdepago VALUES(".$_POST['Idcampo'].",'".$_POST['campo1']."',".$_POST['campo2'].",'".$_POST['campo3']."',".$_POST['campo4'].");";
      echo $sql;
      //Ejecutar($sql,$Con);
}
...
<title>Insertar Metodo Pago</title>
...
<div align="center">
                    <h1 class="page-header">Insertar Metodo Pago</h1>
</div>
