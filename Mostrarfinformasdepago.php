...
$query_R18 = "SELECT * FROM finformasdepago";
...
<title>Mostrar Formas De Envio</title>
...
?>
<div align="center">
                    <h1 class="page-header">Mostrar Forma De Pago</h1>
</div>
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" class="table table-striped table-bordered table-hover">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_R18['IdFormaPago']; ?></td>
        <td><?php echo $row_R18['Nombre']; ?></td>
        <td><?php echo $row_R18['Status']; ?></td>
        <td><?php echo $row_R18['Observacion']; ?></td>
        <td><?php echo $row_R18['IdVenta']; ?></td>
        <td><?php echo $row_R18['IdCompra']; ?></td>
      </tr>
