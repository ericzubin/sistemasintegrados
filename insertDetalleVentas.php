...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO vendetalleventas (IdDetalleVenta, IdVenta, IdProducto, PrecioUnitario, Cantidad, Descuento) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['IdDetalleVenta'], "int"),
...
<title>Insertar Detalle Ventas</title>
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input class="form-control" type="text" name="IdDetalleVenta" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
