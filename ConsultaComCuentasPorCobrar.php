...
$Campo=$_POST['Campo'];
$Query="SELECT * FROM comcuentaporcobrar where $Campo = '$Criterio'";
...
for($a=0; $a < mysqli_num_rows($Consulta) ; $a++)
  ...
  echo ("<td> $fila[5] </td>");
  echo ("<td> $fila[6] </td>");
  echo ("<td> <a href='ActualizarCompras.php?IdCuentaPorCobrar".$fila[0]."&Fecha=".$fila[1]."&Monto=".$fila[2]."&Status=".$fila[3]."&Plazo=".$fila[4]."&Tasa=".$fila[5]."&IdVenta=".$fila[6]."'> Actualizar</a></td>");
