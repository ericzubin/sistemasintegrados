...
<title>Consultar Detalle Ventas</title>
...
?>
<div align="center">
                    <h1 class="page-header">Consultar Detalle Ventas</h1>
</div>
<div class="col-lg-2">
...
for($a=0; $a < mysqli_num_rows($Consulta) ; $a++)
    ...
    echo ("<td> <a class='btn btn-primary' href='ActualizarDetalleVentas.php?Id=".$fila[0]."&TipoPermiso=".$fila[1]."&Status=".$fila[2]."&FechaOtorgacion=".$fila[3]."&FechaVencimiento="."'> Actualizar</a></td>");
