...
if ( array_key_exists("ActualizarDepartamento", $_POST) ) {
  $Con=Conectar();
  $sql= "UPDATE finingresos set IdIngreso=".$_POST['IdIngreso'].",Fecha='".$_POST['Fecha']."',Monto=".$_POST['Monto'].",Status=".$_POST['Status']."  where  IdIngreso=".$_POST['IdIngreso'].";";
  Ejecutar($sql,$Con);
...
<div align="center">
                    <h1 class="page-header">Actualizar Ingreso</h1>
</div>
...
<form method="post" name="form1" action="">
  <table align="center">
    <tr valign="baseline">
      <td nowrap align="right">idIngreos:</td>
