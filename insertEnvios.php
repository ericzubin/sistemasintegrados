...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="IdEnvio" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="DomicilioEntrega" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">IdFormaEnvio:</td>
      <td><input type="text" name="IdFormaEnvio" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
