...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO vendevoluciones (IdDevolucion, Fecha, Motivo, IdVenta, IdCompra) VALUES (%s, %s, %s, %s, %s)",
...
<form method="post" name="form2" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input type="text" name="IdDevolucion" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="Motivo" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
