...
$query_R18 = "SELECT * FROM invactivosfijos";
...
<title>Mostrar Mostrar Activos fijos</title>
...
?>
<div align="center">
                    <h1 class="page-header">Mostrar Activos fijos</h1>
</div>
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" class="table table-striped table-bordered table-hover">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_R18['IdActivo']; ?></td>
        <td><?php echo $row_R18['Nombre']; ?></td>
        <td><?php echo $row_R18['Caracteristicas']; ?></td>
        <td><?php echo $row_R18['Estado']; ?></td>
        <td><?php echo $row_R18['TipoActivo']; ?></td>
        <td><?php echo $row_R18['IdSucursal']; ?></td>
      </tr>
