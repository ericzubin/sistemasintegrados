...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO fincuentasporcobrar (IdCuentaPorCobrar, Fecha, Monto, Status, Plazo, Tasa, IdVenta) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['IdCuentasPorCobrar'], "int"),
...
<title>Insertar Cuentas Por Cobrar</title>
<!-- Bootstrap Core CSS -->
...
<div align="center">
                    <h1 class="page-header">Insertar Cuentas Por Cobrar</h1>
</div>
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      <td nowrap align="right">IdCuentaPorCobrar:</td>
      <td><input class="form-control" type="text" name="IdCuentasPorCobrar" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
